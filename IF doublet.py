...
filename = "DESI_WDJ005526.32+294311.82_bin0p2.dat"
...
#%%
start_B = 12E6 #starting B-field for spline 
...
print(chi_min_2)
##%%
dataIFlist = [popt_Gauss_2[0], popt_Gauss_2[1], 0, 0, popt_Gauss_1[0], popt_Gauss_1[1], \
              chi_B_guess, chi_B_guess_2, chi_min, chi_min_2, begin, finish, 0, 0, start_Gauss_2, \
              end_Gauss_2, 0, 0, start_Gauss_1, end_Gauss_1]
#dataIFlist
#%%
cexceldata = np.zeros((1,21)) # 1,24
